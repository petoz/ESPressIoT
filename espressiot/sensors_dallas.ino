...
//
// Code for:
// Dallas 1-Wire Temperature-Sensors (DS18x20) using the DallasTemperature and
// OneWire Libraries for Arduino
//
...
#define DALLAS_IDX 0
// conversion time depends on precision (12 bit=750ms, 11 bit=375ms, 10
// bit=187.5ms...)
...
void updateTempSensor() {
  if (millis() - lastSensTime >= DALLAS_SMP_TIME) {
